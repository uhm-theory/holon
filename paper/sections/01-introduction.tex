...
unique coarsest CPTP-compatible Grothendieck topology (T-187~\status{T});
...
The complete formalization (over 180 theorems with proofs and interactive documentation)
is available at \url{https://holon.sh}.
