...
\begin{enumerate}[leftmargin=2em]
  \item \textbf{Reframes the hard problem.} Two-aspect monism
        (Section~\ref{subsec:two-aspect}) eliminates the explanatory gap by refusing the
        ontological separation that creates it. Physics and experience are two projections
        of $\Gam$; the residual irreducibility (Gap $> 0$, T-55) is a structural property
        of self-reference, not a mystery.
  \item \textbf{Derives physics from consciousness (and vice versa).} The Einstein field
        equations (Appendix~\ref{app:einstein}), quantum mechanics
        (Section~\ref{subsec:qm-limit}), and the Standard Model structure (T-53, T-64)
        emerge from the same axioms that define consciousness.
  ...
  \item \textbf{Derives all four axioms.} The Cohesive Closure Theorem (T-186) upgrades
        ...
        (canonicity of Bures) proves that A2 is the unique coarsest CPTP-compatible
        topology. A4 ($\omega_0$) is a derived spectral property. No free parameters
...
The complete formalization --- all theorems with proofs, interactive documentation,
cross-references, and the status registry --- is open at \url{https://holon.sh}.
