...
\begin{enumerate}[leftmargin=2em]
  ...
  \item \textbf{Closes all residual mathematical gaps
        (T-210--T-219).} Ten theorems close the last gaps of the
        ...
        decomposition argument). After T-210--T-219 plus three
        clarifications of implicit assumptions (A4 simple spectrum,
        $f_0$ zeta well-definedness, Bures stratified site) the
        framework admits no further mathematical or categorical
        lacunae.
\end{enumerate}
