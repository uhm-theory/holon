...
\begin{enumerate}[leftmargin=2em]
  ...
  \item \textbf{Closes all residual mathematical gaps
        (T-210--T-216).} Seven theorems close the last gaps of the
        ...
        T-205 (T-215), and a closed-form analytical
        $\varepsilon_{\mathrm{eff}}$ (T-216, upgrading T-176). After
        T-210--T-216 the framework admits no further mathematical or
        categorical lacunae.
\end{enumerate}
