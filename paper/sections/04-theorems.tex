...
\subsection{Extended closures: T-217--T-222 + clarifications}
...
(2026)~\citep{debrota2026heptalemma,debrotalist2026preprint}.
...
Giraud). Formalise the five theses of List~\citep{list2025quadrilemma}
...
\begin{itemize}[leftmargin=2em,nosep]
  ...
  \item T-222: \emph{resource-theoretic} closure (UHM is
        MRQT-complete).
\end{itemize}
These four closures jointly establish UHM as self-grounding
\emph{and} resource-theoretically universal, with the Lawvere
fixed point $\rhostar$ serving simultaneously as the dynamical
attractor, the categorical self-model, the structural invariant,
and the multi-resource Pareto-optimum.
...
\paragraph{Summary.}
After T-210--T-222, UHM's foundational framework has no remaining
...
The foundational theorems T-210 through T-221 close all identified gaps of
