...
**OP-3. Бифуркации на границе жизнеспособности.** 🟧 *Существенно решена; остаётся остаток.* Переход при $P = 2/7$ теперь классифицирован: тип катастрофы — нормальная форма ласточкин-хвост/трикритическая с точными среднеполевыми экспонентами $\alpha=\tfrac12, \beta=\tfrac14, \gamma=1, \nu=\tfrac12, \delta=5$ (T-160/T-161 [Т]), критическое замедление **существует** и выведено — на нём построен [протокол раннего предупреждения](./bifurcation#раннее-предупреждение), — а микроскопическая граница Фазы III пришпилена точно складкой окна питания (T-259 [Т]: квинтика с группой Галуа $S_5$, доказуемо нерадикальная). **Что остаётся открытым:** классификация *пост-катастрофных сценариев* — в какой бассейн падает система после складки (посттравматический рост vs хроническая декомпенсация) как функция профиля возмущения, и точная геометрия границ бассейнов.

**OP-4. Топология пространства неподвижных точек.** 🟧 *Ядро единственности решено.* Для полной нелинейной динамики $\mathcal{L}_\Omega = \mathcal{L}_0 + \mathcal{R}$ существует **не более одной** нетривиальной неподвижной точки $\rho^*_\Omega \neq I/7$ в области жизнеспособности (T-124c [Т], через итеративное сжатие + спектральную щель T-39a) — так что при условиях F4 «множественные идентичности» для динамики исключены. **Что остаётся открытым:** структура $\mathrm{Fix}(\varphi)$ для самого оператора самомоделирования *вне* режима сжатия — при ослаблении F4 (слабая связь, почти вырожденные спектры) могут ли сосуществовать несколько $\varphi$-неподвижных точек, и какая бифуркация их порождает? Клинические случаи диссоциативного расстройства личности мотивируют именно этот вопрос ослабленного режима.
...
- **Организационная устойчивость → $r_{\text{stab}}$.** Радиус устойчивости $r_{\text{stab}}$ даёт количественную меру «запаса прочности» организации. Компания с высоким $P$ переживёт кризис; компания на грани ($P \approx 2/7$) рухнет от малейшего толчка.
...
4. **11 открытых проблем** — от бакалаврского проекта (OP-6: вычисление $\Phi$ при $N=7$) до потенциального прорыва (OP-9: границы применимости, OP-11: этика когерентных систем); у двух из них (OP-3 бифуркации, OP-4 единственность неподвижной точки) ядра с тех пор решены T-160/T-161/T-259 и T-124c, с заострёнными остатками.
