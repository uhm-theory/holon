...
- $r_{\mathrm{stab}}$ — [радиус устойчивости](./stability#радиус-устойчивости) (T-104 [Т])
...
### 8.5 За границами: оптимальный поток и его гравитационная грань {#за-границами-оптимальный-поток}

Границы T-109–T-112 — потолки для *любого* обучающего алгоритма. Две поздние теоремы закрывают нормативную и физическую стороны вопроса:

- **Наилучший алгоритм существует и единствен** ([T-263](/docs/core/dynamics/evolution#теорема-наилучший-обучающий-поток) [Т]+[С]): сам канал регенерации есть натурально-градиентный поток наискорейшего спуска $D(\rho_*\|\Gamma)$, движущийся по смесевой геодезической в метрике Кубо–Мори — единственной монотонной метрике с дуально-плоской структурой (Грасселли–Стритер). Его статистическая ставка — режим $a=1$ ($O(1/k)$); потолки, в которые он упирается, — в точности T-109–T-112, на минимальном носителе $N=7$ (T-113).
- **У обучаемости есть гравитационное дополнение** ([T-264](/docs/physics/gravity/einstein-equations#теорема-информационно-гравитационная-взаимность) [Т при FP]): квантовая информация Фишера пространственно-временных Gap-фаз удовлетворяет $G_N^{(ST)}\cdot\langle\mathrm{QFI}\rangle_{\mathrm{ST}} = 8\pi N\mu^2$ — чем лучше фазы обучаемы, тем слабее гравитация, а вакуумный член есть квадрат необучаемости часового канала ($\Lambda \propto \mathcal{G}_O^2$, T-254). Ванчуринское «гравитация — эффективность обучения» тем самым получает знак и сектора.
...
| T-263 (Оптимальный обучающий поток) | Алгоритм, *достигающий* этих границ: единственный наискорейший BKM-спуск | [Эволюция §3](/docs/core/dynamics/evolution#теорема-наилучший-обучающий-поток) |
| T-264 (Инфо-гравитационная взаимность) | Гравитационная грань обучаемости: $G\cdot\langle\mathrm{QFI}\rangle = 8\pi N\mu^2$ | [Уравнения Эйнштейна §3.2a](/docs/physics/gravity/einstein-equations#теорема-информационно-гравитационная-взаимность) |
