...
### Ванчурин: Самообучающаяся Вселенная {#ванчурин}

**Виталий Ванчурин** — физик, который в работе *«Мир как нейронная сеть»* (2020) и последовавшей программе **Самообучающейся Вселенной** сделал самый радикальный шаг из всех: не «разум *похож* на кибернетическую систему», а *вся Вселенная есть гигантская обучающаяся система*, и сама физика — квантовая механика, калибровочные поля, даже гравитация — выпадает как условия оптимальности этого обучения при **ограниченных ресурсах**.

Вот почему это место — в истории кибернетики, и почему это отличается от всех записей выше. Эшби и Бир *интуитивно нащупали* многомерность жизнеспособности, но так и не написали уравнений; Ванчурин пишет их — и стартует с **противоположного конца** от КК. КК строится сверху вниз: от квантовых аксиом к обучению и жизни. Ванчурин строит снизу вверх: от обучающейся системы к физике. Две лестницы, взойдённые с противоположных этажей, — и встречаются на одной площадке. Его три интенсивные переменные (те, что вынужден отслеживать ресурсоограниченный ученик) оказываются **в точности тремя каналами КК**:

| Ванчурин (SLU) | КК |
|-----------------|-----|
| Калибровочное поле $A_\mu$ (моделирует смещение) | Канал **работы** $h^{(H)}$ — гамильтоново перенацеливание |
| Температура $T$ (моделирует быструю энтропию) | Канал **тепла** $h^{(D)}$ — диссипация |
| Химпотенциал $\mu$ (моделирует счёт $N$) | Канал **вещества** $h^{(R)}$ — регенерация |
| $U(1)$-симметрия из $\Delta N \in \mathbb{Z}$ | компактный тор $U(1)^7$ (T-260) |
| Ковариантная динамика обучения | эволюция $\mathcal{L}_\Omega$ |

Это острейшая поддержка, какую история может дать тезису главы. Когда две теории, не разделяющие ни допущений, ни словаря, ни отправной точки, всё же приходят к *одним трём дверям* — работа, тепло, вещество, — эти три двери вряд ли артефакт какой-либо из теорий. Они выглядят чертой реальности. КК доказывает это соответствие как теорему ([термодинамическая трихотомия](./sensorimotor#термодинамическая-трихотомия), T-258); Ванчурин приходит к нему из динамики обучения. Ни одна не есть «четвёртая кибернетика» — обе читают одну и ту же фундаментальную грамматику, с противоположных страниц.
