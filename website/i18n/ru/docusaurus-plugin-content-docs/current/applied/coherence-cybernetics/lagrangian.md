...
А под шестичленным *портретом* лежит трёхпоточный *скелет*. Когда вы действительно выписываете уравнения движения, шесть членов не остаются шестью — они сами собой организуются ровно в три геометрических движения (T-262 [Т], [метриплектическая структура](./variational#метриплектическая-геометрия)):

- один **поворот без трения** — обратимая, гамильтонова часть (кинетический + потенциальный + топологический члены), жёсткий разворот, не тратящий порядка;
- два **скольжения под гору** — необратимая, градиентная часть: диссипативный член есть скольжение к максимуму энтропии, регенеративный — скольжение к самомодели, каждое в своей естественной геометрии.

Вот почему портрет держится вместе, а не рассыпается в список: шесть мазков вычерчивают один поворот и два спуска. Это же с первого взгляда объясняет, почему диссипативный и регенеративный члены сопротивлялись обычному лагранжиану и потребовали удвоенного контура Швингера–Келдыша из §6 — у скольжения под гору нет симметричного во времени действия; оно подчиняется *наискорейшему спуску*, вариационному близнецу стационарного действия. Два принципа вместе — стационарность для поворота, наискорейший спуск для скольжений — замыкают динамику без остатка.

Лагранж мечтал свести механику к алгебре. В Gap-теории эта мечта реализована: вся динамика интериорности — следствие одной формулы и принципа $\delta S = 0$ — дополненного, для необратимой половины бытия, зеркальным принципом наискорейшего спуска.
