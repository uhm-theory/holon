...
- **Жизнеспособность** $P > 2/7$ — **[Т при нижней оценке backbone-инъекции] для воплощённых** (T-149: backbone-инъекция обеспечивает κ-доминирование; Шаг 3 T-149 — [С при этой нижней оценке], не из чистых аксиом); **[С]** для изолированных голонов (C20 — нерелевантна, т.к. изолированный голон мёртв навсегда, T-148)
...
2. **[Т при нижней оценке backbone-инъекции]** Для воплощённых систем: $P(\rho_*^{(12)}) > P_{\mathrm{crit}} = 2/7$ ([T-149](/docs/core/dynamics/evolution#теорема-жизнеспособность-аттрактора), Шаг 3 [С])
:::
...
Нетривиальность аттрактора — **безусловный** результат [Т]: спектральная щель линейной части $\mathcal{L}_0$ обеспечивает конвергенцию, а регенерация $\mathcal{R}$ удерживает систему от тривиального $I/7$. Жизнеспособность ($P > 2/7$) для **воплощённых** голонов — [Т при нижней оценке backbone-инъекции] ([T-149](/docs/proofs/consciousness/substrate-closure#t-149), Шаг 3 [С]). Теорема КК-5 — прямое следствие **универсальности** аксиом A1–A5 внутри ∞-топоса.
:::
...
**Связь:** [Квантовая взаимная информация](https://en.wikipedia.org/wiki/Quantum_mutual_information), [Неполнота Лоувера](/docs/core/foundations/consequences#неполнота-ловера)
:::
