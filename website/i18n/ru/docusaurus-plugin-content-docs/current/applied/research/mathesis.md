...
Егор Чурилов ([«Метастемология. Вместо манифеста»](https://anticomplexity.org/posts/metastemologiya-vmesto-manifesta/), 2025) выдвигает радикальный тезис: проблема современного знания — **не** в нехватке данных и **не** в ошибках рассуждений, а в **архитектуре самих когнитивных протоколов**. Протокол сам — объект, подлежащий реконфигурации.
