...
Примеры: $T_{\text{УГМ}}$ (392 номера реестра, 7 статусов, 5 аксиом), $T_{\text{IIT}}$ (5 постулатов, $\Phi$, Q-shape), $T_{\text{GWT}}$ (глобальное зажигание, доступ), $T_{\text{FEP}}$ (свободная энергия, марковское одеяло).
