...
Основные результаты этого документа — **[Т]** — бифуркации типа $A_4$ (swallowtail) доказаны через теорему Арнольда (1972): три физически независимых управляющих параметра $(\kappa, \alpha, \Delta F)$ и приближённая $\mathbb{Z}_2$-симметрия пурити однозначно определяют тип катастрофы. См. [Теорему об $A_4$-бифуркации](/docs/consciousness/hierarchy/interiority-hierarchy#теорема-a4-бифуркация).
:::
...
Этот колимит **недостижим** для конечных систем ([неполнота Лоувера](/docs/core/foundations/consequences#неполнота-ловера), T-55 [Т]), но **асимптотически приближаем**: каждый шаг $\tau_{\leq n} \to \tau_{\leq n+1}$ реализуем ([T-67](/docs/consciousness/hierarchy/interiority-hierarchy#теорема-l3-k4) [Т]).
