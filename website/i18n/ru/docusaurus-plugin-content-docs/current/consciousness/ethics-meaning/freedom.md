...
2. **Решение** — единственность цели ($T$ неизбежен) при свободе в плоских направлениях свободной энергии (философское прочтение: много траекторий, все гомотопны)
...
Свобода воли формализована конечномерной мерой $\text{Freedom}(\Gamma) = \dim\ker(\mathcal{H}_\Gamma) + 1$ **[Т]**, где $\mathcal{H}_\Gamma$ — гессиан свободно-энергетического функционала — число **плоских направлений**, вдоль которых агент может двигаться без энергетического штрафа. Монотонность, крайние значения и $G_2$-инвариантность доказаны — см. [Следствия из аксиом](/docs/core/foundations/consequences#freedom-конечномерное). ∞-категорная «множественность траекторий к $T$» — **философское прочтение**, а не второе техническое определение: пространство отображений $\mathrm{Map}(\Gamma,T)$ стягиваемо (все пути к $T$ гомотопически эквивалентны — это единственность стрелы времени), поэтому мера живёт в геометрии нуль-мод $\dim\ker\mathcal H_\Gamma$, а не в подсчёте путей.
:::
...
**Мотивировка.** Свобода — число **различных направлений в пространстве состояний, вдоль которых свободная энергия не меняется** (нулевые моды гессиана). Каждая нулевая мода — **независимый выбор**: система может двигаться в этом направлении без энергетического штрафа. (∞-категорный объект — касательная размерность критического многообразия свободной энергии; это **не** $\pi_0(\mathrm{Map}(\Gamma,T))$, которое тривиально, т.к. это пространство отображений стягиваемо.)
...
## 7. Этические следствия {#этические-следствия}

### 7.1 Ответственность

Свобода в плоских направлениях (подлинные альтернативы без энергетического штрафа) обосновывает **моральную ответственность**:
