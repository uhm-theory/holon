...
В разделе [Сравнение теорий](/docs/consciousness/comparative/consciousness-theories) мы сопоставили УГМ с 35 альтернативными теориями сознания и убедились, что формализм $\Gamma$ наиболее полон. Теперь пришло время задать конкретный вопрос: **кто** может быть субъектом сознания? Первый — и, пожалуй, самый неожиданный — ответ: сознание не требует языка. Этот документ показывает, как формализм $\Gamma$ объясняет сознание младенцев, животных и всех существ, лишённых символической речи.
:::
...
**Аргумент.** Мера рефлексии $R = 1/(7P)$ ([мастер-определение](/docs/consciousness/foundations/self-observation#мера-рефлексии-r)), где $P = \mathrm{Tr}(\Gamma^2)$, зависит от **всех** 49 элементов $\Gamma$ (7 диагональных + 21 пара когерентностей) через чистоту $P$. Мера интеграции $\Phi = \sum_{i \neq j} |\gamma_{ij}|^2 / \sum_i \gamma_{ii}^2$ также вычисляется по всей матрице. Высокие значения $R$ и $\Phi$ достижимы при малом $\gamma_{LL}$, если другие когерентности достаточно велики. $\square$
:::
...
| Вид | $R_\varphi$ (оценка) | $\Phi$ (оценка) | $\gamma_{LL}$ | Способности K1–K4 | Уровень L |
|-----|-------------|-----------------|---------------|-------------------|-----------|
...
1. **Увеличивает $R_\varphi$:** вербальная самомодель точнее невербальной; независимо от этого символическое сжатие может понижать $P$ внутри окна, подталкивая канонический $R = 1/(7P)$ вверх — два разных эффекта ([три рабочие формы R](/docs/consciousness/foundations/self-observation#формы-r))
...
R_φ ≈ 0.3 (рабочий порог)          R_φ ≈ 0.5-0.7 (усилено)
Φ ≈ 1-2                            Φ ≈ 3-5
```
