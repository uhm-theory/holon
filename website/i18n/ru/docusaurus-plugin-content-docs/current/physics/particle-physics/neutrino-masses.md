...
Эмпирическая проверка: see-saw формула $m_\nu = m_D^2 / M_R$ с выведенным $M_R$ даёт $m_\nu \sim 0.06$ эВ, согласно $\sqrt{\Delta m^2_{32}} \approx 0.05$ эВ из осциллляционных данных. Это **проверка согласованности**, не источник предсказания $M_R$.
:::
