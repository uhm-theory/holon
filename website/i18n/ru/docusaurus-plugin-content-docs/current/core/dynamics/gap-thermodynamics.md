...
**Шаг 5 (Единственность).** Спектральная тройка единственна с точностью до $G_2$-эквивалентности ([T-42a](/docs/proofs/categorical/uniqueness-theorem) [Т]). Спектральное действие — единственный $G_2$-инвариантный функционал на $(S^1)^{21}$, совместимый с NCG (теорема Чамседдин–Конна). $\blacksquare$
