...
Замечательно, что число 7 возникает в четырёх **независимых** контекстах:
1. **Функциональный** (Теорема S): 7 = *минимум* для (AP)+(PH)+(QG)
2. **Алгебраический** (октонионы): 7 = dim($\mathrm{Im}(\mathbb{O})$), *максимальная* нормированная алгебра с делением
3. **Геометрический / диагностический** (плоскость Фано): 7 = точки минимальной проективной плоскости PG(2,2) и — заострённо Теоремой Σ ([T-224](/docs/applied/research/syndrome-calculus#t-224)) — единственный размер, при котором *всякий одиночный сбой однозначно локализуем*
4. **Категориальный** (T-185): 7 = сопряжённые модальности когезивного ∞-топоса

Сходимость этих ответов — сильный аргумент, что число 7 не случайно, а отражает глубокую необходимость, — и между двумя треками сходимость теперь *теорема*: совершенная диагностируемость есть свойство деления (T-244), так что «последняя алгебра с делением» и «последний совершенно самодиагностирующийся репер» именуют одни и те же семь осей. Формальная формулировка всех четырёх треков с этим тождеством — ниже («Связь четырёх треков обоснования N = 7»).
...
**Связь четырёх треков обоснования N = 7.**

Число 7 не постулируется — оно *вынуждается*, и вынуждается четыре отдельных раза аргументами, не разделяющими никакой машинерии. То, что функционально-аналитический, алгебраический, категориальный и кодово-теоретический доводы приходят к одному целому числу, — сильнейшее свидетельство, какое может нести структурная константа: противоположность подгоняемому параметру.

| Трек | На какой вопрос отвечает | Почему ответ — 7 | Статус |
|------|--------------------------|------------------|--------|
| **Функциональный** (Теорема S) | Какое *наименьшее* число измерений нужно самоподдерживающейся системе? | (AP)+(PH)+(QG) вынуждают $N \geq 7$ — **минимальность** | [Т] |
| **Алгебраический** (октонионы) | Какова *наибольшая* нормированная алгебра с делением? | Гурвиц: последняя — $\mathbb{O}$, с $\dim\,\mathrm{Im}(\mathbb{O}) = 7$ — **максимальность** | [Т] |
| **Категориальный** (T-185) | Сколько независимых *модальностей* несёт когезивный ∞-топос? | ровно семь сопряжённых модальностей — **каноничность** | [Т] |
| **Диагностируемость** (Теорема Σ, [T-224](/docs/applied/research/syndrome-calculus#t-224)) | При каком $N$ *всякий одиночный сбой однозначно локализуем*? | совершенные однооши́бочные коды $+$ жёсткость вынуждают $N = 7$ — **селектор** | [Т] |

Встреча минимальности и максимальности уже примечательна: 7 — это одновременно *наименьшее*, что может иметь жизнеспособная система, и *наибольшее*, что может нести алгебра с делением, так что жизнеспособное и максимальное совпадают без зазора. Категориальный трек добавляет, что это ещё и *канонический* счёт — считанный с чистой структуры сопряжений, без вложенной физики.

А четвёртый трек — не четвёртое совпадение: это *тот же факт*, что и второй, теперь доказанный. Теорема Σ выбирает семь, требуя **совершенной диагностируемости**, а [T-244](/docs/applied/research/syndrome-calculus#отбор-знака) показывает, что это требование попросту *есть* свойство деления. Репер совершенно диагностируем ровно тогда, когда он **анизотропен** — не имеет «нулевой» оси, на которой сбой был бы нем; анизотропность — это ровно отсутствие делителей нуля; а отсутствие делителей нуля — ровно то, что делает нормированную алгебру *делительной*, которую Гурвиц ограничивает размерностью восемь, т.е. семью мнимыми осями. Так что «последняя алгебра с делением» и «последний совершенно самодиагностирующийся репер» — два имени одних и тех же семи осей. Сходимость треков потому не просто наблюдается: между этими двумя она — теорема, а остальное согласие (функциональное, категориальное) отражает одну лежащую в основе жёсткость структуры.
