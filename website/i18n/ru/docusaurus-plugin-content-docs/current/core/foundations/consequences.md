...
где $T$ — терминальный объект ∞-топоса $\mathrm{Sh}_\infty(\mathcal{C})$, а «non-trivial» означает пути с нетривиальной гомотопической структурой (см. [Аксиома Ω⁷](./axiom-omega)).
:::
