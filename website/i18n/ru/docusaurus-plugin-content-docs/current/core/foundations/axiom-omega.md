...
Ключевой факт: **контрактивность Бюреса при CPTP** (минимальность метрики Бюреса среди монотонных метрик, классификация Петца) обеспечивает стабильность покрытий автоматически.
