...
description: "Вывод времени из структуры категории C — определения и ключевые результаты"
---
...
Резюме доказательства эквивалентности (полное строгое доказательство: [Теорема →](/docs/proofs/dynamics/emergent-time#6-теорема-об-эквивалентности)):
