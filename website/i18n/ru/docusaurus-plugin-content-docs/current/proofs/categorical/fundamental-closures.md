...
| **T-214** | Мета-теорема о трудной проблеме (позитивная неразрешимость) | Неподвижная точка Ловера + T-55 | [Т] |
...
1. **[Т]** $W$ **не может** быть выражен как морфизм, внутренний для $\mathrm{Th}_\mathrm{UHM}$, без нарушения неполноты Ловера (T-55 [Т]).
...
**Зависимости**: T-54 [Т] (внутренняя теория существует), T-55 [Т] (неполнота Ловера), T-188 [Т] (локализация трудной проблемы), Lawvere 1969, Yanofsky 2003.
...
| T-214 | Мета-теорема о трудной проблеме | [И] остаточная | **[Т] позитивная неразрешимость** | Неподвижная точка Ловера |
...
| T-214 | Мета-теорема о трудной проблеме | [И] остаточная | **[Т] позитивная** | Ловер |
