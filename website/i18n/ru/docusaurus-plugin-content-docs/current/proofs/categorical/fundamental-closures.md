...
факторизуется через $[\Gamma_S]_{G_2}$, следовательно инвариантен относительно $(\mathsf{PT})$.
...
| T-216 | Аналитическая ε<sub>eff</sub> | [H] без формулы | **[T при T-64]** | Замкнутая форма |
...
| §9 | Протокол π<sub>bio</sub> | [H] специфический | **Спецификация полная** | EEG/fMRI/HRV |
