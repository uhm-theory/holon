...
**Совместная область.** Char-I + II + III вместе фиксируют Бюреса привилегированием **специфического кластера физических интерпретаций**: минимум-информационное-расстояние + очищение-когерентность + классическое-оценочное-насыщение. Другие Petz-члены канонически связаны с другими интерпретационными кластерами (Гессиан-энтропии для BKM, асимптотика-Холево для RLD). Выбор Бюреса в УГМ — потому **обоснованное физическое предпочтение**, не уникально формально-вынужденный выбор в чистой инфо-геометрии.
...
**Статус:** A2 — [Т] по тройной характеризации. Полное внутреннее аудит-обновление (с детальной проверкой знаков Кубо-Андо, аргументом порождения coverage→топология, и решением возражения о тривиальной топологии) задокументировано в `internal/audit-2026-04-13-T187-upgrade.md`. $\square$
