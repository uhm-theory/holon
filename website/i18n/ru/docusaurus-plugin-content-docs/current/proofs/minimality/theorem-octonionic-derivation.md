...
| **Трек B** | P1 + P2 → $\mathbb{O}$ → $\dim(\mathrm{Im}(\mathbb{O})) = 7$ (данный документ) | [Т] Математически строго |
...
**Доказательство (пересмотрено — без циркулярной апелляции к $\lambda=1$).**
...
- $G_2$-ковариантность: присутствует при $k=3$ через PG(2,2) (T-2), **отсутствует** при $k=2$ (2-элементная блочная структура имеет $S_7\times S_2$-симметрию, несовместимую с $G_2\subset SO(7)$).
