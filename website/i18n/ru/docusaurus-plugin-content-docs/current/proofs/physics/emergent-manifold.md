...
- (c) Эмерджентная метрика $g_{\mu\nu}$ наследует полную диффеоморфную инвариантность из спектрального действия Шамседдина–Конна (стандартный результат NCG)
