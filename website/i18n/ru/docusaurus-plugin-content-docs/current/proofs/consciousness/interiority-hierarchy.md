...
Термин **«Квалиа»** (Qualia) исторически связан с *сознательным* субъективным опытом (Nagel, 1974; Chalmers, 1996). УГМ использует его для описания фундаментального свойства *любой* системы, включая атомы, что создаёт:
