...
const matrixInfo: Record<string, { name: string; desc: string }> = {
  ...
  EE: { name: 'Опыт', desc: 'Активность переживания' },
  ...
  AD: { name: 'Сигнал', desc: 'Динамическое различение' },
  AL: { name: 'Категоризация', desc: 'Логическое различение' },
  AE: { name: 'Внимание', desc: 'Осознанное различение' },
  AO: { name: 'Эмерджентность', desc: 'Различения из основания' },
  AU: { name: 'Дифференциация', desc: 'Различение в целом' },
  SD: { name: 'Метаболизм', desc: 'Динамическое поддержание формы' },
  SL: { name: 'Закон', desc: 'Логически устойчивая структура' },
  SE: { name: 'Гештальт', desc: 'Структура переживания' },
  SO: { name: 'Архетип', desc: 'Формы из основания' },
  SU: { name: 'Симметрия', desc: 'Структурное единство' },
  DL: { name: 'Вычисление', desc: 'Логический процесс' },
  DE: { name: 'Аффект', desc: 'Переживание изменения' },
  DO: { name: 'Генезис', desc: 'Порождение из основания' },
  DU: { name: 'Целенаправленность', desc: 'Интегрированное изменение' },
  LE: { name: 'Понимание', desc: 'Переживание связности' },
  LO: { name: 'Необходимость', desc: 'Логика бытия' },
  LU: { name: 'Самосогласованность', desc: 'Логическая интеграция' },
  EO: { name: 'Глубина', desc: 'Опыт ↔ источник' },
  EU: { name: 'Единство сознания', desc: 'Интегрированный опыт' },
      ...
      <div className={styles.heroContent}>
        <div className={styles.heroText}>
          ...
          <p className={styles.heroDescription}>
            Единственный примитив — ∞-топос. Пять аксиом — и ни одного
            произвольного выбора. Время возникает изнутри, монизм доказуем,
            внутреннее — не надстройка над физикой, а условие жизнеспособности.
          </p>
...
const docSections: DocSection[] = [
  ...
  },
  {
    ...
    link: '/docs/proofs/theorem-octonionic-derivation',
  ...
  },
  {
    ...
    items: ['dΓ/dτ = −i[H,Γ] + 𝒟[Γ] + ℛ[Γ,E]', 'Диссипация из логики, регенерация из опыта', 'Глобальный аттрактор'],
  },
  {
  ...
  {
    title: 'Сознание',
    description: 'Пять уровней L0→L4',
    link: '/docs/core/consciousness/self-observation',
    items: ['L0: интериорность — у всех Γ ≠ I/7', 'L2: когнитивные квалиа (R≥⅓, Φ≥1, D≥2)', 'L4: унитарное сознание (теоретический предел)'],
  },
  {
...
export default function Home(): ReactNode {
  return (
    <Layout
      ...
      description="Унитарный Голономный Монизм — аксиоматическая теория на основе ∞-топоса Sh∞(𝒞). Время, структура и сознание выводятся как следствия пяти аксиом.">
      <HomepageHeader />
      <main>
        <MatrixSection />
