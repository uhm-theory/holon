...
*Число 7 есть минимальная размерность пространства состояний Голонома, необходимая для замыкания (M,R)-системы Розена, обладающей:*
...
$$
\dim(\mathcal{H}) \geq 7 \quad \text{для любого } \mathbb{H} \text{, удовлетворяющего (AP), (PH), (QG)}
$$
...
2. Maturana, H. & Varela, F. (1980). *Autopoiesis and Cognition: The Realization of the Living*. Springer.

3. Perelman, G. (2002-2003). *The entropy formula for the Ricci flow and its geometric applications*. arXiv:math/0211159.
