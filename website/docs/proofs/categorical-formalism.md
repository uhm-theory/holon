...
**Определение 2.6 (Категория Exp — основное определение).**

Принимаем **Вариант C** как основное определение, с **Вариантом B** как эквивалентным представлением для вычислений:
...
**Разрешение:** Принимаем одну из эквивалентных стратегий:

**Стратегия A (рекомендуемая):** История не модифицируется морфизмами:

$$
f_h^\Phi(h) := h
$$

История обновляется внешне временным параметром $t$, а не категорными морфизмами. Это согласуется с интерпретацией морфизмов как «мгновенных» квантовых каналов.

**Стратегия B:** Расширенная история как пространство путей:
