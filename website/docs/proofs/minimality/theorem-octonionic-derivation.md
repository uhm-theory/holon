...
**Теорема T2 (Полнота покрытия) [Т].** Связность $G_H$ + примитивность $\mathcal{L}_\Omega$ ⟹ $\lambda_{ij} \geq 1$ для всех пар. Непокрытая пара делает канал «слепым» к ненулевой когерентности $\gamma^*_{ij}$, нарушая (AP).
