...
Без $E$ частичный след $\mathrm{Tr}_{-E}$ не определён (нет подпространства, по которому проводится след). Система становится «зомби» — функциональна, но без внутреннего опыта.
