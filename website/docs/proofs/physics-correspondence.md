...
graph LR
    ...
    CHI --> LK[L_k = √χ_{S_k}<br/>операторы Линдблада]
...
Весь раздел 5 описывает **гипотетическую связь** УГМ со Стандартной моделью. Все утверждения требуют строгого обоснования.
:::
