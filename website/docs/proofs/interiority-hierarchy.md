...
Исследования глобального рабочего пространства (GWT, Баарс) показывают, что сознательный доступ возникает при:
...
**Связь с IIT (Теория интегрированной информации):**

Тонони (2004, 2008) показал, что $\Phi > 0$ необходимо для сознания. Однако для *рефлексивного* сознания требуется более сильная интеграция.
