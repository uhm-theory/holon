...
Минимальная рефлексия для автопоэзиса — когда самомодель содержит достаточно информации для различения «себя» и «не-себя». Из геометрии пространства матриц плотности:

$$
R_{\text{th}} = \frac{1}{3} \approx 0.333
$$

**Доказательство:** См. [Теорема о пороге рефлексии](/docs/core/foundations/axiom-septicity#пороги-l2-геометрическая-мотивация).
