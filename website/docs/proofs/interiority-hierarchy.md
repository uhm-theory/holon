...
:::info Теоретический статус
Пороговые значения **выведены** из структуры теории:
...
Полное доказательство см. [Теорема о пороге рефлексии](/docs/core/foundations/axiom-septicity#пороги-l2-геометрическая-мотивация).
...
**Доказательство:** $\Phi = 1$ означает, что когерентности (связи между измерениями) имеют такой же вес, как диагональ (локализация). Это минимальное условие интеграции системы. См. [Теорема о пороге интеграции](/docs/core/foundations/axiom-septicity#пороги-l2-геометрическая-мотивация).
...
| **Математика** | $\mathrm{Quale} = \mathrm{Exp}(\rho_E) \cdot \Theta(R - 1/3) \cdot \Theta(\Phi - 1)$ |
| **Онтологический статус** | Эмерджентный феномен |
| **Требования к рефлексии** | $R \geq 1/3 \approx 0.333$ (теорема) |
| **Требования к интеграции** | $\Phi \geq 1$ (теорема) |
...
:::info Усиление No-Zombie Theorem
Базовая теорема показывает универсальность L0. Следующая теорема устанавливает **каузальную необходимость** L2 для определённых классов поведения.
:::
...
Пусть $\varphi(\Gamma)$ — самомодель системы. При $R < R_{\text{th}}$ по [Теореме о пороге различимости](/docs/core/foundations/axiom-septicity#пороги-l2-геометрическая-мотивация):
$$
...
1. [Оператор самомоделирования](/docs/proofs/formalization-phi) $\varphi(\Gamma)$ требует конкретизации для реальных систем
2. Возможны промежуточные уровни (L1.5?) — требует исследования
3. Как экспериментально измерить $R$ и $\Phi$ для биологических систем?
4. Теорема о комбинации: как из L0-систем возникает L2-система?

:::note Решённые вопросы
Значения порогов теперь **выведены** из структуры теории:
- $R_{\text{th}} = 1/3$ — [Теорема о пороге рефлексии](/docs/core/foundations/axiom-septicity#пороги-l2-геометрическая-мотивация)
- $\Phi_{\text{th}} = 1$ — [Теорема о пороге интеграции](/docs/core/foundations/axiom-septicity#пороги-l2-геометрическая-мотивация)
:::
