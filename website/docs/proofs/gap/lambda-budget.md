...
description: "Полная цепочка 6 пертурбативных механизмов подавления Λ → 10⁻⁴¹·⁵, дефицит 79 порядков, программа непертурбативного замыкания"
---

# Доказательство: Бюджет космологической постоянной Λ

Полная цепочка **6 пертурбативных механизмов** подавления вклада в космологическую постоянную $\Lambda$ в рамках [Gap-динамики](/docs/core/dynamics/gap-dynamics) и [G₂-структуры](/docs/physics/gauge-symmetry/g2-structure). Пертурбативный бюджет даёт подавление на **41.5 порядков** из необходимых 120. Оставшийся дефицит 79 порядков — центральная [открытая проблема](/docs/reference/status-registry).
...
## 4. Итоговый бюджет {#итоговый-бюджет}
...
| **Итого достигнутое** | **41.5 из 120** | |
| **Дефицит** | **79 порядков** | **Открытая проблема** |
...
## 5. Программа непертурбативного замыкания [П] {#программа}
...
## 6. Сравнение с другими подходами {#сравнение}
...
## 7. Классификация эпистемического статуса {#эпистемический-статус}
