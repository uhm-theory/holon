...
Данный документ содержит доказательства связи между категориальным определением φ и вариационным принципом, а также вывод FEP Фристона как классического предела УГМ. Теорема 3.1 — **[Т]** (примитивность $\mathcal{L}_\Omega$ [доказана](/docs/core/operators/lindblad-operators#примитивность-ℒω)). Теорема 4.2 — **[С]** (зависит от отождествления генеративной модели). Теорема 5.1 — **[Т]**.
:::
...
где $\mu$ — инвариантная мера на пространстве состояний (единственность $\mu$ гарантирована [примитивностью $\mathcal{L}_\Omega$](/docs/core/operators/lindblad-operators#примитивность-ℒω) **[Т]**).
:::
...
**Замечания:**
1. Существование и единственность инвариантной меры $\mu$ гарантированы [примитивностью $\mathcal{L}_\Omega$](/docs/core/operators/lindblad-operators#примитивность-ℒω) **[Т]** (Evans 1977, Spohn 1976)
...
$$
\mathcal{F}_{УГМ} = H(q) + D_{KL}(q \| p) = -\langle \ln p \rangle_q
$$
...
Отождествление $\mathcal{F}_{УГМ} = F_{FEP}$ выполняется при условии $p_i = P(T_i, S)$ (генеративная плотность совпадает с опорной).
...
**Теоремы:**
1. **Теорема 3.1 [Т]:** Категориально определённый φ минимизирует функционал $S_{spec} + D_{KL}$ ([примитивность $\mathcal{L}_\Omega$ доказана](/docs/core/operators/lindblad-operators#примитивность-ℒω))
