...
Помимо порога жизнеспособности $P > 2/7$, теория определяет пороги сознательности [L2](/docs/proofs/interiority-hierarchy#уровень-2-когнитивные-квалиа-cognitive-qualia): $R \geq 1/3$, $\Phi \geq 1$, $D_{\text{diff}} \geq 2$. Для полной иерархии L0→L4 — см. [иерархию интериорности](/docs/proofs/interiority-hierarchy).
:::
...
**Из [теоремы о минимальности](/docs/proofs/theorem-minimality-7):** $N = 7$ — минимальная размерность ([двухтрековое обоснование](/docs/core/foundations/axiom-omega#октонионная-структура)).
