...
| [Опыт](/docs/core/structure/dimension-e) | $E$ | Энтропия активаций | $I_E = \exp(S_{vN}(\rho_{\text{attn}}))$ — [дифференциация опыта](/docs/core/structure/dimension-e#порог-дифференциации-d_min--2) | [Т] |
...
| $E$ (Опыт) | $0.005$–$0.02$ Гц | EEG инфрамедленные | [Голдстоуновские моды](/docs/applied/coherence-cybernetics/goldstone-modes) |
