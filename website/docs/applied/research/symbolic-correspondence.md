...
| Вода | — (чередование) | Связь через $E$ (Опыт) |
...
| Свадхистхана | $E$ ([Опыт](/docs/core/structure/dimension-e)) | $\gamma_{EE}$ |
