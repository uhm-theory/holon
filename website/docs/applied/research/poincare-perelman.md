...
**Примечание:** Это может быть совпадением. Глубокая математическая связь между потоком Риччи и порогом чистоты — **открытый вопрос**, не доказанный факт.
:::
