...
graph TD
    ...
    L2[L2: Когнитивные квалиа<br/>R ≥ 1/3, Φ ≥ 1]

    L0 -->|"добавляется Φ > 0"| L1
    L1 -->|"добавляется R ≥ R_th"| L2
...
| Конститутивный | Микро-субъекты комбинируются | $\mathbb{H}_1 \otimes \mathbb{H}_2$ | Проблема комбинации (решена в УГМ) |
...
| **Панинтериоризм (УГМ)** | Всё имеет L0, не всё — L2 | $\mathrm{L0} \supsetneq \mathrm{L2}$ | — |
