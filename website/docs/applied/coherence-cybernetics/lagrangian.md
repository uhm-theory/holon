...
Действие $S_{\text{Gap}} = \int d\tau\, \mathcal{L}_{\text{Gap}}$ не порождает диссипативных членов $-\Gamma_2\dot{\theta}$ через стандартное условие $\delta S/\delta\theta = 0$. Уравнения движения (см. [Вариационные принципы](./variational)) корректны как феноменология, но формально требуют либо **диссипативной функции Рэлея**, либо метода **Кальдейры--Леггетта** (интегрирование по степеням свободы среды). Лагранжиан — **феноменологическая модель** с чёткой диагностической ценностью, но не строгий вариационный принцип в гамильтоновом смысле.
:::
