...
:::warning Замечание о размерности $\mathcal{L}_{\mathrm{diss}}$
...
Это не три независимых постулата, а три грани одного объекта — действия Швингера-Келдыша. Подробный вывод: [Термодинамика Gap](/docs/core/dynamics/gap-thermodynamics#полный-лагранжиан).
