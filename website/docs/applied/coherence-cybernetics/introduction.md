...
**Теорема:** Именно 7 измерений — минимальное число, необходимое для системы с автопоэзисом, феноменологией и квантовым основанием ([двухтрековое обоснование](/docs/core/foundations/axiom-omega#октонионная-структура)). **См.:** [Доказательство минимальности](/docs/proofs/theorem-minimality-7)
