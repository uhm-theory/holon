...
- **L0**: у системы *есть* E-проекция — минимальная «тень» внутреннего. Термостат? Возможно. Бактерия? Вероятно. Это самый слабый смысл слова «опыт» — не более чем ненулевая проекция на измерение интериорности.
