...
Три уровня «внутренней жизни» системы:

| Уровень | Название | Условие |
|---------|----------|---------|
| L0 | Интериорность | $\Gamma \neq I/7$ |
| L1 | Феноменальная геометрия | $\Phi > 0$, структура на $\mathbb{P}(\mathcal{H}_E)$ |
| L2 | Когнитивные квалиа | $R \geq 1/3$, $\Phi \geq 1$, $D_{\text{diff}} \geq 2$ |
