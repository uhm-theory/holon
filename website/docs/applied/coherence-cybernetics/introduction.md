...
|-----------|-----------|-------|----------------|
| **Инженеры ИИ** | [Реализация](./implementation) | [Модельные системы](./model-systems) → [Приложения](./applications) | [Определения](./definitions) → [Теоремы](./theorems) |
...
- [Алгебра Gap](./gap-algebra) — Чой-Ямиолковский, ранги, код Хэмминга
- [Бифуркации](./bifurcation) — катастрофы Уитни, кризисная динамика
- [Немарковская динамика](./non-markovian) — ядро памяти, «циклы горя»
- [Модельные системы](./model-systems) — 5 точно решённых моделей

### Вариационная структура
- [Лагранжиан](./lagrangian) — 6-членный лагранжиан, потенциал V_Gap
- [Вариационные принципы](./variational) — принцип действия-границы, соотношения Онзагера
- [Эффективная температура](./effective-temperature) — T_eff, критическая температура, метрика Фишера

### Топологическая защита
- [Топологическая защита](./topological-protection) — 5 механизмов защиты когерентности
- [Фазовая диаграмма](./phase-diagram-cc) — 3 фазы, кибернетическая интерпретация
- [Голдстоуновские моды](./goldstone-modes) — инфрамедленные флуктуации, протокол верификации
- [G₂-заряды Нётер](./g2-noether-cc) — 14 зарядов, тождества Уорда
