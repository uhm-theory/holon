...
:::warning Гипотетические связи
Соответствия между FEP и КК — **концептуальные аналогии**, не формальные изоморфизмы. FEP оперирует байесовскими вероятностями, КК — квантовыми матрицами плотности.
:::

| FEP (Фристон) | Концептуальный аналог в КК |
|---------------|-----|
| Свободная энергия $F$ | [Свободная энергия фон Неймана](/docs/core/dynamics/evolution#свободная-энергия-и-градиент-δf) |
