...
graph TD
    subgraph "Аксиома Ω⁷"
        AX1["1. ∞-Топос Sh∞ C"]
        AX2["2. Конечномерность"]
        AX3["3. Ограничение Page-Wootters"]
        AX4["4. Терминальный объект"]
        AX5["5. Вариационный принцип"]
        AX6["6. Стратификация"]
        AX7["7. Унивалентность"]
    end
    subgraph "Следствия"
        S["Теорема S: dim=7"]
        APQ["AP+PH+QG"]
...
| Аксиома | Ключевое следствие | Формула |
|---------|-------------------|---------|
