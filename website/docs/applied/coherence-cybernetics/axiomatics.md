...
где:
- $\kappa_0$ — базовая скорость регенерации, [структурный анзац](/docs/core/foundations/axiom-septicity#структурный-анзац-kappa0): $\kappa_0 = |\gamma_{OE}| \cdot |\gamma_{OU}| / \gamma_{OO}$
