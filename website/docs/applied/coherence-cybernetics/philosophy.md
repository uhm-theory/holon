...
Ключевой переход от описания к предписанию — **конвенция** [О]: Благо := $dP/d\tau > 0$ (см. [Определение 1](/docs/consciousness/ethics-meaning/value-consciousness#определение-блага)). Гильотина Юма не нарушена — «должно» вводится определением, а не выводится из «есть».

Этические следствия для ИИ, медицины и прав животных: [Этика УГМ → Моральная теория](/docs/consciousness/ethics-meaning/value-consciousness#моральная-теория).
:::
