...
## 7. Эмпирическая валидация σ-профилей {#эмпирическая-валидация}
...
### 7.1 Секторная декомпозиция $7 = 1_O \oplus 3_{\{A,S,D\}} \oplus \bar{3}_{\{L,E,U\}}$ {#секторная-валидация}

Теоретическое предсказание из [spacetime.md](/docs/core/foundations/spacetime#теорема-секторная-декомпозиция) (T-52 [Т]): семь измерений делятся на «лёгкий» сектор $\{A,S,D\}$ и «тяжёлый» сектор $\{L,E,O\}$ с мостом $U$.
...
### 7.2 Иерархия Фано-линий {#фано-иерархия-эмпирическая}
...
### 7.3 Триада жизнеспособности $\{L,O,U\}$ {#триада-жизнеспособности-эмпирическая}
...
### 7.4 Аномалии и импликации {#аномалии}
