...
| 3 | [7-мерный стресс](#предсказание-3-семимерный-тензор-напряжений) | $\sigma_{\mathrm{sys}} \in \mathbb{R}^7$ | **[Т]** мат. / **[С]** эмп. | Отсутствует |
...
| 5 | [Коллективное сознание](#предсказание-5-масштабная-инвариантность-сознания) | $C(\mathbb{H}_{1 \otimes \ldots \otimes n}) > 0$ | **[Т]** нетр. / **[С]** жизн. | Частично в [IIT](/docs/reference/glossary#связанные-теории) |
