...
**См.:** [Когнитивная иерархия](./cognitive-hierarchy)
...
- [Когнитивная иерархия](./cognitive-hierarchy) — когнитивные уровни К1-К5
- [Жизнеспособность](/docs/core/dynamics/viability) — $P$, $P_{\text{crit}}$
- [Иерархия интериорности](/docs/proofs/interiority-hierarchy) — уровни L0→L1→L2→L3→L4, пороги
