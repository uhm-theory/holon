...
### Теорема 9.2 (Масштабная инвариантность) [С]
...
Структура [Голонома](/docs/core/structure/holon) инвариантна относительно масштаба. Верно при условии сохранения $G_2$-типа при масштабировании: если $\mathbb{H}^{(k)}$ наследует $G_2$-структуру от компонент, масштабная инвариантность следует из единственности $G_2$-представления на $\mathbb{C}^7$.
