...
Композитный голоном обладает **собственным** стационарным состоянием $\rho_*^{(12)} \neq \alpha\rho_*^{(1)} + (1-\alpha)\rho_*^{(2)}$ (из нелинейности $\mathcal{R}$ и примитивности $\mathcal{L}_\Omega^{(12)}$). Доказательство — [Теорема 9.3](#теорема-93-эмерджентность) [Т].
:::
...
**Шаг 1.** Композитный линдбладиан $\mathcal{L}_\Omega^{(12)} = \mathcal{L}_\Omega^{(1)} \otimes \mathrm{id}_2 + \mathrm{id}_1 \otimes \mathcal{L}_\Omega^{(2)} + \mathcal{L}_{\mathrm{int}}$ примитивен (из [Теоремы 9.1 (КК-5)](#теорема-91-фрактальное-замыкание) [Т]) → единственное стационарное состояние $\rho_*^{(12)}$.
...
### Теорема 10.1 / T-92 (Эквивалентность условий) [Т] {#теорема-101-эквивалентность-условий}
...
graph TD
    ...
    T91 --> T93["Теорема 9.3: Эмерджентность [Т]"]
