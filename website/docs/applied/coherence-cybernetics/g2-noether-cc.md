...
## 1. 14 нётеровских зарядов: обзор [Т] {#обзор}

$G_2$-инвариантность [лагранжиана Gap](/docs/core/dynamics/gap-thermodynamics) порождает, по теореме Нётер, **14 сохраняющихся зарядов**. Они разделяются на два класса:
...
| 2: $\{S, D, E\}$ | Структура–Динамика–Опыт | Баланс организация–процесс–интериорность |
| 3: $\{D, L, U\}$ | Динамика–Логика–Единство | Баланс процесс–логика–интеграция |
| 4: $\{L, E, O\}$ | Логика–Опыт–Основание | Баланс рассуждение–опыт–заземление |
| 5: $\{E, U, A\}$ | Опыт–Единство–Артикуляция | Баланс интериорность–единство–выражение |
