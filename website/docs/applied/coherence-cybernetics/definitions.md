...
<details>
<summary>Историческая справка: эмпирические формулы (сняты Sol.81)</summary>
...
| **Когерентная неподвижная точка** | $\Gamma^*_{\mathrm{coh}}$ | $P > 2/7$ при [C20](/docs/core/dynamics/evolution#теорема-жизнеспособность-аттрактора) | κ-доминирование | [С] ([T-98](/docs/core/dynamics/evolution#теорема-баланс-чистоты-аттрактора)) |
...
- $\rho^*_\Omega \to \Gamma^*_{\mathrm{coh}}$: при достаточном κ-доминировании — $\kappa(\rho^*) / \lambda_{\mathrm{gap}}$ велико ([T-98](/docs/core/dynamics/evolution#теорема-баланс-чистоты-аттрактора) [Т], жизнеспособность [С] при C20)
...
**См.:** [T-98](/docs/core/dynamics/evolution#теорема-баланс-чистоты-аттрактора), [T-96](/docs/core/dynamics/evolution#теорема-нетривиальность-аттрактора)
:::
