...
**Сходимость:** Область $\mathcal{V}$ выпукла (как надуровневое множество функции чистоты), поэтому при липшицевости градиента метод сходится к локальному минимуму.
