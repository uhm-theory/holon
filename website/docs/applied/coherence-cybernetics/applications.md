...
- $C = \Phi \times D_{\text{diff}} \times R$ — [мера сознательности](/docs/consciousness/foundations/self-observation#мера-сознательности-c)
:::
...
| Регенерация | $\kappa = \kappa_{\text{bootstrap}} + \kappa_0 \cdot \mathrm{Coh}_E$ | Опыт необходим для устойчивости | [→](./axiomatics#связь-регенерации-и-e-когерентности) |
