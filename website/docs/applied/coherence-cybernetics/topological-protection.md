...
:::info Каноническое определение
Полное доказательство через теорему Лавёра и L4$\neq$Gap=0: [Неполнота Ловера](/docs/core/foundations/consequences#неполнота-ловера). Формализация: [Фано-канал](/docs/proofs/gap/fano-channel#l4-не-gap-0).
:::
