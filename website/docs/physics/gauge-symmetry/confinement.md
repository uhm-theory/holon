...
5. Струнное натяжение выражается через Gap-параметры [Г] (расхождение $\sim 7\times$)
...
| Струнное натяжение из Gap-параметров ($\sim 60$ МэВ vs 440 МэВ) | [Г] |
...
1. **Количественная проверка конфайнмента.** Струнное натяжение $\sigma$ из Gap-параметров расходится с экспериментом в $\sim 7$ раз. Необходима самосогласованная [RG-эволюция](/docs/physics/gauge-symmetry/rg-flow) Gap-параметров в секторе 3-to-$\bar{3}$.
