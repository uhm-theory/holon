...
**(a)** Общее число $G_2$-инвариантов для эрмитовой $7 \times 7$ матрицы: $48 - 14 = 34$, где $14 = \dim(G_2)$. Следовательно, $G_2$-калибровочная свобода редуцирует 48-мерное пространство параметров до **34-мерного** пространства физически различимых конфигураций.
