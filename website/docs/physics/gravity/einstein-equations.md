...
**Статус [Т] (Sol.40):** Полная спектральная тройка $(A, H, D)$ из [T-53 [Т]](/docs/core/foundations/spacetime#теорема-спектральная-тройка) удовлетворяет аксиомам Конна. Спектральное действие Чамседдина-Конна $S = \mathrm{Tr}(f(D_A/\Lambda))$ воспроизводит действие Эйнштейна-Гильберта с $G_N = 3\pi/(7 f_2\Lambda^2)$ [Т]. Дополнительный аргумент: теорема Лавлока (применимость к эмерджентной метрике — [Г], см. [анализ ограничений](#34-ограничения-аргумента-лавлока) ниже).
...
**Основной аргумент (Sol.40, спектральное действие).** Полная спектральная тройка $(A, H, D)$ с конечной частью из [T-53 [Т]](/docs/core/foundations/spacetime#теорема-спектральная-тройка) порождает спектральное действие $\mathrm{Tr}(f(D_A/\Lambda))$, разложение которого по коэффициентам Сили-де Витта даёт действие Эйнштейна-Гильберта с $G_N = 3\pi/(7 f_2 \Lambda^2)$ (подробнее — [полное спектральное действие](/docs/physics/gravity/quantum-gravity#теорема-полное-спектральное-действие)).
...
:::warning Ограничения аргумента Лавлока (статус [Г])
Аргумент через теорему Лавлока содержит **три незакрытых пробела**. Однако основной результат (Теорема 1.3) теперь [Т] благодаря Sol.40: спектральное действие из полной спектральной тройки T-53 безусловно воспроизводит уравнения Эйнштейна. Аргумент Лавлока остаётся как дополнительный, его пробелы не влияют на статус Теоремы 1.3.
:::
...
Для повышения аргумента Лавлока до [Т] необходимо:
...
:::note
Эти пробелы относятся **только** к дополнительному аргументу Лавлока. Основной аргумент (спектральное действие из полной спектральной тройки, Sol.40) — **безусловен** [Т].
:::
