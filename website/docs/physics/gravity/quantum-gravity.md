...
- ~~**Фоновая независимость ($M^4$ выведено)**~~ — [Т] (T-120): коммутативность макроалгебры (T-117) + реконструкция Гельфанда–Конна (T-119) → произведение троек $M^4 \times F_{\text{int}}$ — теорема, не постулат. [Доказательство](/docs/proofs/physics/emergent-manifold)
:::
:::
