...
CP-нарушение в CKM-матрице возникает из **комплексности** перекрытий $\langle\chi_i|\Gamma_{EU}|\chi_j\rangle$ между фермионными спинорами различных поколений. Эта комплексность имеет единственный источник — кубический потенциал $V_3$:
...
4. **Сильное CP: $\theta_\text{QCD} = 0$** — автоматическое следствие изотропности Gap-вакуума в секторе $3$-to-$\bar{3}$.
:::
