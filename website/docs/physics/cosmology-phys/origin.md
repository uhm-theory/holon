...
Нестабильность Источника — **концептуальный аргумент**, не формальная теорема. Требуется показать, что [динамика](/docs/core/dynamics/evolution) $\frac{d\Gamma}{d\tau}$ неизбежно уводит от $\Gamma_{\odot}$.
:::

:::info Статус: [Г] Гипотеза
...
Источник нестабилен **[Г]**, потому что абсолютная симметрия — это **отсутствие информации**.

:::info Статус: [П] Программа
...
где $\delta\Gamma$ — малое возмущение, нарушающее симметрию ($\|\delta\Gamma\|_F \ll 1$, см. [норма Фробениуса](/docs/core/dynamics/coherence-matrix#норма-фробениуса)).

:::warning Открытые вопросы формализации
- Механизм возникновения $\delta\Gamma$ — требуется связь с [диссипатором](/docs/core/dynamics/evolution#логический-лиувиллиан) $\mathcal{D}[\Gamma]$
...
| **Нестабильность Источника** | [Г] Гипотеза | Требуется анализ устойчивости Ляпунова |
| **Механизм флуктуаций $\delta\Gamma$** | [П] Программа | Не формализован |
| **Самоусиление нарушения симметрии** | [П] Программа | Требуется доказательство положительной обратной связи |
