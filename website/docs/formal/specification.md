...
:::info Определение 𝕆 ([структурный вывод](../proofs/theorem-octonionic-derivation))
...
**Таблица умножения** определяется 7 триплетами [плоскости Фано](../proofs/theorem-octonionic-derivation#плоскость-фано):
