...
| **КК-5: Фрактальное замыкание** | Композит жизнеспособных голономов жизнеспособен; универсальность A1–A5 в ∞-топосе | [Т] | [Теорема](./applied/coherence-cybernetics/theorems#теорема-91-фрактальное-замыкание) |
...
| **КК-6: Масштабная инвариантность** | Бюрес-контрактивность CPTP + КК-5 → структура сохраняется при агрегации | [Т] | [Теорема](./applied/coherence-cybernetics/theorems#теорема-92-масштабная-инвариантность) |
...
| **Параметр сжатия $k = 1 - R$** (T-62, Sol.77) | $k$ не свободен: $k = 1 - R$, $R = \mathrm{Tr}(\Gamma\varphi(\Gamma))$; адаптивное самомоделирование | [Т] | [Теорема](./consciousness/foundations/self-observation#теорема-k-из-r) |
...
| **[Композитные системы](./core/dynamics/composite-systems)** | КК-5 [Т], топологическая защита Gap [Т], эмерджентная геометрия |
