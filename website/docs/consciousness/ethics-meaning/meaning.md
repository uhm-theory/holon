...
См. [Происхождение Вселенной](/docs/core/cosmology/origin#почему-вообще-что-то-есть) — $\Gamma$ существует, потому что **самосогласованность требует существования**.
...
Утверждение $dD_{\text{diff}}/d\tau > 0$ — [нефальсифицируемое допущение](/docs/core/cosmology/origin#эволюция-от-источника): любое наблюдаемое уменьшение дифференциации можно интерпретировать как локальное явление на фоне глобального роста.
:::
...
- [Происхождение Вселенной](/docs/core/cosmology/origin) — космогенез и $\Gamma_{\odot}$
