...
У человека: $R \approx 0.5$ означает $\|\Gamma - \varphi(\Gamma)\|_F^2/\|\Gamma\|_F^2 = 0.5$. Самомодель «ловит» половину деталей $\Gamma$ — не идеально, но достаточно для структурирования «я vs. не-я». У амёбы: $R \approx 0.1$ — самомодель почти бесполезна, различие «субъект — объект» размыто. У термостата: $R \approx 0$ — самомодели нет вовсе.
...
|---------|--------------------------|-----|
| **Ранний Гуссерль** | Нет сознания | Нет: есть L0/L1 опыт без интенциональности |
...
6. **Отсутствие интенциональности не равно отсутствию опыта** — No-Zombie теорема гарантирует L0 для любой $\Gamma \in \mathcal{D}(\mathcal{H})$
