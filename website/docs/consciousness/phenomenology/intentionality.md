...
Апперцептивная интенциональность — направленность внимания на объект:

$$
f_{\text{аппер}}: \Gamma \to \Gamma', \quad \text{где } |\gamma'_{AE}| > |\gamma_{AE}|
$$

Механизм: морфизм $f_{\text{аппер}}$ усиливает когерентность между Артикуляцией (различение) и Интериорностью (переживание). Субъективно: «я вижу/слышу/чувствую *это*».
...
Усиление связи между Логикой и Интериорностью. Субъективно: «я *понимаю* это». Когерентность $\gamma_{LE}$ — «эвиденция» ([квалиа #16](/docs/consciousness/phenomenology/qualia-structure#таксономия)).
...
Усиление связи между Динамикой и Единством. Субъективно: «я *хочу/намерен* достичь этого». Когерентность $\gamma_{DU}$ — «телеология» ([квалиа #15](/docs/consciousness/phenomenology/qualia-structure#таксономия)).
