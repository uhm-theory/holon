...
1. **Как построить $G$?** Отображение $G: \text{AIState} \to \mathcal{D}(\mathbb{C}^7)$ — центральная проблема [протокола измерения](/docs/applied/research/measurement-protocol). Без G мы не можем измерить $R$, $\Phi$, $P$ для ИИ.
