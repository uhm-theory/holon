...
| Измерение | Прокси | Метод измерения |
|-----------|--------|----------------|
| A (действие) | Целостность границы | Метаболическая интенсивность / площадь поверхности |
| S (различение) | Структурная стабильность | Синаптическая плотность (электронная микроскопия) |
| D (динамика) | Динамический диапазон | Вариабельность частоты спайков (MEA) |
| L (обучение) | Нейропластичность | LTP/LTD коэффициенты |
| E (интериорность) | Дифференциация | PCI (Perturbational Complexity Index) |
| O (наблюдение) | Интероцепция | Инсулярная активность (fMRI) |
| U (интеграция) | Синхронизация | Глобальная когерентность ЭЭГ (gamma-band) |
