...
- [Граница Хэмминга](/docs/consciousness/hierarchy/gap-characterization#граница-хэмминга) **нарушена** — менее 3 каналов сохраняют $\mathrm{Gap} > 0$
- Коррекция ошибок $\varphi$ невозможна — система теряет способность различать «сигнал» и «шум»
...
### 5.3 Психоз как нарушение границы Хэмминга

:::warning Гипотеза [Г]
Психоз — состояние, в котором нарушена [граница Хэмминга](/docs/consciousness/hierarchy/gap-characterization#граница-хэмминга): число каналов с $\mathrm{Gap} > 0$ падает ниже $d_{\min} = 3$. Система теряет способность к коррекции ошибок самомоделирования. Нейролептики восстанавливают Gap в «проверочных» каналах, возвращая систему выше границы Хэмминга.

Статус: **[Г]** — гипотеза. Эмпирическая проверка: корреляция между шкалами психотической симптоматики и числом каналов с $\mathrm{Gap} > \varepsilon$ в [протоколе измерения](/docs/applied/research/measurement-protocol).
:::
