...
- **Нижний порог** $P > 2/7$: различимость от $I/7$ (5 независимых путей вывода: [T-39](/docs/core/foundations/axiom-septicity#критическая-чистота-теорема))
- **Верхний порог** $P \leq 3/7$: $R = 1/(7P) \geq 1/3$ — необходимая рефлексия для L2 ([T-126](/docs/proofs/consciousness/conscious-window#t-126))
- При $P > 3/7$: $R < 1/3$ — недостаточное самомоделирование, сознание L2 невозможно
...
| Критерий | Порог | Теорема |
|----------|-------|---------|
| $P > P_{\text{crit}}$ | $2/7$ | T-39 |
| $R \geq R_{\text{th}}$ | $1/3$ | T-126 |
| $\Phi \geq \Phi_{\text{th}}$ | $1$ | T-129 |
| $D_{\text{diff}} \geq D_{\min}$ | $2$ | T-151 |
| $\|\sigma_{\text{sys}}\|_\infty < 1$ | $< 1$ | [T-155 [Т]](/docs/proofs/consciousness/substrate-closure#t-155) |

Пятый критерий $\|\sigma\|_\infty < 1$ (T-155, consciousness gate) гарантирует, что ни один сектор не находится в полном стрессе. При $\sigma_{\max} = 1$ когнитивный канал заблокирован и обучение невозможно.
