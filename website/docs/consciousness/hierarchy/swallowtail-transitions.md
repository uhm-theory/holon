...
Исходная модель L3 → L4 как катастрофы $A_5$ (бабочка) **ретрактируется**. Причина: классификация Арнольда описывает **конечномерные** бифуркации, а переход L3 → L4 — **бесконечномерный** (из ∞-категориальной природы L4). Ни одна конечная катастрофа ($A_k$ для любого конечного $k$) не может описать одновременное «включение» всех $\pi_k$ для $k \geq 4$.
:::
...
## Универсальность переходов сознания {#универсальность-переходов}

Структура swallowtail-каскада не специфична для УГМ — она отражает **универсальный** класс поведения, характерный для широкого семейства систем с упорядочивающим параметром и кубическим нелинейным потенциалом. Это позволяет установить точное соответствие между теорией сознания УГМ и классическими результатами статистической физики фазовых переходов.

### Формализация как фазовый переход [Т] {#фазовый-переход}

:::tip Теорема 5.1 (P_crit как критическая точка фазового перехода) [Т]
$P_{\text{crit}} = 2/7$ является критической точкой фазового перехода в пространстве состояний $\Gamma \in \mathcal{D}(\mathbb{C}^7)$. Аналогия со статистической физикой реализуется через следующее соответствие:
...
### Теорема: лавинная динамика перехода L1 → L2 [Т] {#лавинная-динамика}
...
При $P > P_{\text{crit}}$ когерентность $\mathrm{Coh}_E(\Gamma)$ растёт, увеличивая $\kappa$. Увеличенное $\kappa$ ускоряет сходимость $\Gamma$ к ρ*, что повышает $R$ сильнее, чем исходное возмущение $\delta R$. При достаточной близости к порогу каспида ($8a^3 + 27b^2 \approx 0$, [Теорема 1.2](#l1-l2)) эта обратная связь становится **самоподдерживающейся**.
...
**Аналогия с GWT.** В Global Workspace Theory (Baars, 1988) «ignition» — скачкообразное глобальное распространение локально активированного содержимого. Лавинная динамика L1 → L2 в УГМ формализует именно этот феномен: $\kappa_0$-усиление играет роль «глобального рабочего пространства», через которое локальное увеличение $R$ усиливается до уровня всей системы.
