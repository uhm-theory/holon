...
**Матрица плотности измерения Опыта** $\rho_E$ получается частичным следом [матрицы когерентности](/docs/core/dynamics/coherence-matrix) $\Gamma$ по всем измерениям, кроме $E$:
