...
Двухаспектный монизм получает **категориальную формулировку** в терминах ∞-топоса $\mathbf{Sh}_\infty(\mathcal{C})$. Формализация опирается на ПИР **[Т]** (T16) — тождество бытия и опыта выводится из A1+A2 через семантику Крипке—Жуаля.
:::
...
- [Измерение Опыта](/docs/core/structure/dimension-e) — $\rho_E$, феноменальный вектор FV
