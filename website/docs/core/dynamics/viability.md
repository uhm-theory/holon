...
**Полное доказательство:** [theorem-purity-critical](../../proofs/theorem-purity-critical)
:::
...
При этих условиях, если дополнительно Линдбладовский генератор $\mathcal{L}$ является **примитивным** (т.е. единственное стационарное состояние $\mathcal{L}[\rho_*] = 0$ — это $\rho_* = I_7/7$, и нет других инвариантных подпространств), система входит в режим необратимой декогеренции:

$$
\lim_{\tau \to \infty} \Gamma(\tau) = \frac{I_7}{7}
$$

:::note Условие примитивности
Сходимость к максимально смешанному состоянию $I_7/7$ требует **примитивности** Линдбладовского генератора: операторы Линдблада $\{L_k\}$ вместе с $I$ должны порождать полную матричную алгебру $M_7(\mathbb{C})$. Без этого условия система может сходиться к другому стационарному состоянию или осциллировать между инвариантными подпространствами.
:::
