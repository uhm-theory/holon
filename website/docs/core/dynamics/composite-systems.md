...
:::caution Теорема 1.3 (Стрела → V₃ ≠ 0) [П]
...
При PT-преобразовании: $V_3 \to -V_3$. Стрела времени требует $V_3 \neq 0$ → ассоциатор $\neq 0$ → [Аксиома P2](../foundations/axiom-septicity).
:::

### Полная цепочка моста

:::caution Теорема 1.4 (Полная цепочка моста) [П]
$$
(AP) + (PH) + (QG) \implies P1 + P2
$$

через 8 шагов. Шаги 6--7 имеют статус **[П]** (программа), остальные доказаны **[Т]**.
:::

**Схема цепочки:**

```
(AP) Альтернативный постулат
  ↓  [Т] шаг 1
(PH) Феноменология ≠ тривиальная
  ↓  [Т] шаг 2 (Теорема 1.1)
Hol(C) ≠ id
  ↓  [Т] шаг 3 (Теорема 1.2)
Стрела времени
