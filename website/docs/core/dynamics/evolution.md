...
**Следствие:** Живые системы — диссипативные структуры, поддерживающие $P > P_{\text{critical}}$ за счёт импорта свободной энергии.
...
- $P$ поддерживается выше [критического](./viability#критическая-чистота): $P > P_{\text{critical}} \approx 0.3$
...
graph TD
    ...
    subgraph OP["Открытая система"]
        ...
        LIV["Живая система<br/>P ≈ const > P_crit"]
    end
...
- [Жизнеспособность](./viability) — условия существования и $P_{\text{critical}}$
