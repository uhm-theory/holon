...
**E-когерентность:** См. [определение](/docs/core/foundations/axiom-septicity#структурный-анзац-kappa0). Высокая E-когерентность означает распределённую (не локализованную) структуру опыта.
...
**Граничные случаи:** См. [проверку согласованности](/docs/core/foundations/axiom-septicity#структурный-анзац-kappa0).
...
введена как [структурный анзац](../foundations/axiom-septicity#структурный-анзац-kappa0) с физическим обоснованием, но **не выведена** из фундаментальных принципов.
