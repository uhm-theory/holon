...
:::info Статус теоремы 3.2 [Т] (Sol.75)
Из [T-73](/docs/core/dynamics/gap-operator#теорема-gap-серра) [Т] (Gap = кривизна Серра) и [T-53](/docs/core/foundations/spacetime#теорема-спектральная-тройка) [Т] (спектральная тройка): $\text{Gap}(i,j) \geq 4/(\omega_0^2 \|D_{\text{int}}\|^2) > 0$ для неассоциативных пар. Константа $C = 4/(\omega_0^2 \|D_{\text{int}}\|^2)$ однозначно определена спектральной тройкой (Sol.75) **[Т]**. Повышена с [С] до [Т].
:::
...
:::info Вывод лагранжиана из линдбладиана (Sol.54) [Т]
...
- **$\mathcal{L}_{\mathrm{Ham}} \to \mathcal{L}_{\mathrm{kin}} + \mathcal{L}_{\mathrm{pot}} + \mathcal{L}_{\mathrm{top}}$**: коммутатор $-i[H_{\mathrm{Fano}}, \rho]$ порождает кинетический, потенциальный ($V_{\mathrm{Gap}}$ из [Sol.53](#вывод-vgap-из-спектрального-действия)) и топологический члены.
...
**Самосогласованность стационарности.** При $\dot{\theta} = 0$ и $\theta = \theta^{\mathrm{target}}$ уравнение движения сводится к $\partial V_{\mathrm{Gap}}/\partial\theta = 0$: стационарное состояние линдбладиана ([T-39a](/docs/core/operators/lindblad-operators#примитивность-ℒω) [Т]) совпадает с минимумом $V_{\mathrm{Gap}}$ ([T-64](/docs/core/dynamics/gap-thermodynamics#теорема-глобальная-минимизация) [Т]).
:::
...
:::tip Теорема (Коэффициент $\beta$ из первых принципов, Sol.65) [Т]
...
#### Вывод $V_{\text{Gap}}$ из спектрального действия (Sol.53) [Т] {#вывод-vgap-из-спектрального-действия}
...
| Топологическая защита вакуума | $\pi_2(G_2/T^2) \cong \mathbb{Z}^2$; барьер $\geq 6\mu^2$ [Т] (Sol.48) | [Композитные системы](/docs/core/dynamics/composite-systems#теорема-тополог-защита) |
| Gap = кривизна Серра | Точное отождествление через спектральную тройку [Т] (Sol.52) | [Gap-оператор](/docs/core/dynamics/gap-operator#теорема-gap-серра) |
