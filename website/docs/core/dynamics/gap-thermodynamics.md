...
:::warning Статус теорем 13.4–13.6
Теоремы 13.4–13.6 имеют статус **[Т]** как свойства определённого потенциала $V_{\text{Gap}}$: структура $V_2 + V_3 + V_4$, связь констант и наличие спонтанного минимума следуют из алгебраических свойств $G_2$ и октонионов. Однако сам потенциал $V_{\text{Gap}}$ — часть эффективного лагранжиана Gap-теории (раздел 10), который постулирован **[П]**. Физические следствия (конкретные числовые значения масс, константы связи) имеют статус **[Г]** до получения вывода лагранжиана из аксиом.
:::
