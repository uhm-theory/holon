...
## Роль внутренних часов (Пейдж–Вуттерс)
...
Параметр $\kappa_0$ **выводится** категориально из сопряжения диссипативного и регенеративного функторов. Точная формула **[Т]** (Sol.69, T-88): $\kappa_0 = \omega_0 \cdot |\gamma_{OE}| \cdot |\gamma_{OU}| / \gamma_{OO}$ — единственная через теорему Ченцова–Петца. Полное обоснование см. в [Аксиоме Септичности → Категориальный вывод κ₀](../foundations/axiom-septicity#структурный-анзац-kappa0).
:::
