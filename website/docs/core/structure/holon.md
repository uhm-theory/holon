...
Полная иерархия интериорности L0→L4 определена в [Уровни интериорности](../consciousness/interiority.md). Здесь показаны L0-L2 как базовые уровни. Уровни L3 (сетевое сознание, метастабильно) и L4 (унитарное сознание, теоретический предел) описаны в [Иерархия интериорности](../../proofs/interiority-hierarchy).
:::
...
Термин «Голоном» зарезервирован для конфигураций с **полным автопоэтическим замыканием** (AP)+(PH)+(QG)+(V). Фундаментальные моды и составные конфигурации — **не** Голономы: у них отсутствует автопоэзис (AP) и регенерация (QG). Они являются объектами категории **Hol**, но в вырожденном режиме $R \to 0$, где уравнение эволюции [редуцируется к уравнению Шрёдингера](../../proofs/physics-correspondence#3-редукция-к-квантовой-механике).
:::
