...
Голоном непрерывно эволюционирует согласно уравнению с [эмерджентным внутренним временем](../../proofs/emergent-time) τ:
...
- $-i[H_{eff}, \Gamma]$ — унитарная (обратимая) эволюция
...
Пороги L2 **строго выводятся** из Принципа Информационной Различимости. См. [Иерархия интериорности](../../proofs/interiority-hierarchy) и [Пороги L2](../foundations/axiom-septicity#пороги-l2-строгий-вывод).
...
**Пороги (теоремы из ПИР):**
- $P_{\text{crit}} = 2/7 \approx 0.286$ — [Теорема о критической чистоте](../../proofs/theorem-purity-critical)
- $R_{\text{th}} = 1/3 \approx 0.333$ — [Порог рефлексии](../foundations/axiom-septicity#теорема-порог-рефлексии) (байесовское доминирование)
- $\Phi_{\text{th}} = 1$ (точно) — [Порог интеграции](../foundations/axiom-septicity#теорема-порог-интеграции) (K₁-нетривиальность)
