...
где $R$ — [мера рефлексии](../consciousness/self-observation#мера-рефлексии-r). Пороги имеют **геометрическую мотивацию**. См. [Пороги L2](../foundations/axiom-septicity#пороги-l2-геометрическая-мотивация).

:::info Теорема: Порог интеграции
$\Phi_{\text{th}} = 1$ означает, что когерентности (связи между измерениями) должны иметь **не меньший вес**, чем диагональные элементы (локализация). Это минимальное условие для интегрированной системы.
:::
