...
В отличие от $P_{\text{crit}} = 2/7$, которое выводится из условия различимости от шума, $\Phi_{\text{th}} = 1$ — это **определение** границы интегрированности, а не эмпирически подбираемый порог.
:::
