...
где $R$ — [мера рефлексии](/docs/consciousness/foundations/self-observation#мера-рефлексии-r). Пороги доказаны математически: $P_{\text{crit}}$ [Т], $R_{\text{th}}$ [Т], $\Phi_{\text{th}}$ [О]; ПИР [О] (T16) даёт их онтологическую интерпретацию. См. [Пороги L2](../foundations/axiom-septicity#пороги-l2-строгий-вывод).
