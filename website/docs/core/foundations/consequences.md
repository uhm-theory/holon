...
1. $\Omega$ — субобъектный классификатор $\mathrm{Sh}_\infty(\mathcal{C})$, содержащий все предикаты на $\mathcal{D}(\mathbb{C}^7)$ ([Аксиома Ω⁷](./axiom-omega#субобъектный-классификатор)).
...
**Связь с [самореферентностью голонома](#тождество-бытия-истины-и-интериорности).** Теоремы T-54–T-56 дополняют самореференцию на двух уровнях:
