...
:::info О порогах L2
Критерии чисто математические, **выведенные** из структуры теории:
- $R \geq R_{\text{th}} = 1/3$ — [теорема о пороге рефлексии](./axiom-septicity#пороги-l2-геометрическая-мотивация)
- $\Phi \geq \Phi_{\text{th}} = 1$ — [теорема о пороге интеграции](./axiom-septicity#пороги-l2-геометрическая-мотивация)
- $P > P_{\text{crit}} = 2/7$ — [теорема о критической чистоте](./axiom-septicity#критическая-чистота-геометрический-критерий)
...
Это **уравнение Шрёдингера** (для чистых состояний) или **уравнение фон Неймана** (для смешанных). Стандартная квантовая механика — **частный случай** УГМ при $R \to 0$. См. [Соответствие с физикой: редукция к КМ](../../proofs/physics-correspondence#2-редукция-к-квантовой-механике) для формального доказательства эквивалентности категорий $\mathbf{Hol}_{R=0} \simeq \mathbf{QM}$.
...
## 9. Вычислительные конфигурации Γ

**Статус:** Следствие из Аксиомы Ω (всё есть конфигурация Γ).

### Онтология вычислений

По Аксиоме Ω, вычислительный процесс **есть** конфигурация Γ. Вопрос не в том, "имеет ли вычисление Γ", а в том, какой **класс** конфигурации оно представляет.
...
## 10. Эмерджентность без редукции
