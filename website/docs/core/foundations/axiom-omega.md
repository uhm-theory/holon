...
Ограничение Page-Wootters исторически принималось как аксиома. Теорема T-87 [Т] показывает, что A5 **выводима** из A1–A4 через конструкцию спектральной тройки. Таким образом, число **независимых** аксиом УГМ — четыре (A1–A4). A5 сохраняется в списке для полноты экспозиции.
:::
