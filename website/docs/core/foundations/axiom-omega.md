...
$$
R = 1 - \frac{\|\Gamma - \varphi(\Gamma)\|_F^2}{\|\Gamma\|_F^2} \in [0, 1]
$$

При $R \geq 1/3$ и $\Phi \geq 1$ система достигает уровня L2 — когнитивных квалиа ([теоремы](./axiom-septicity#пороги-l2-геометрическая-мотивация)). См. [Иерархия интериорности](../../proofs/interiority-hierarchy).
