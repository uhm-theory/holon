...
1. ~~**Компактификация:**~~ Реализована через секторную декомпозицию $7 = 1 + 3 + \bar{3}$ [Т]. ~~Открыто: вывод уравнений Эйнштейна на $M^{3+1}$.~~ Решено: $M^4$ выведено ([T-120](/docs/proofs/physics/emergent-manifold#теорема-произведение-троек)), уравнения Эйнштейна — [Т] (T-65).
