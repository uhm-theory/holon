...
Нестабильность Источника — **концептуальный аргумент**, не формальная теорема. Требуется показать, что [динамика](../dynamics/evolution) $\frac{d\Gamma}{d\tau}$ неизбежно уводит от $\Gamma_{\odot}$.
:::
