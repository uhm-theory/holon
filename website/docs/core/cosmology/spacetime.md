...
См. [Соответствие с физикой: ОТО](../../proofs/physics-correspondence#4-связь-с-общей-теорией-относительности) для детальной программы.
...
|--------|-------------|--------|
| **Квантовая механика** | Частный случай УГМ при $R \to 0$ | [Доказано](../../proofs/physics-correspondence#2-редукция-к-квантовой-механике) |
| **Стандартная модель** | Калибровочные симметрии из $\text{Sym}(\Gamma)$ | [Программа](../../proofs/physics-correspondence#5-калибровочные-симметрии-и-стандартная-модель) |
