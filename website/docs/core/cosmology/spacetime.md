...
- **Гравитация:** [П] Программа исследований — связь с ОТО открыта
:::
...
**Глобальное увеличение дифференциации** ($dD_{\text{diff}}/d\tau > 0$) — это [отдельная космологическая гипотеза](./origin#направление-эволюции), имеющая статус **нефальсифицируемой философской позиции**.
...
:::warning [П] Программа исследований
...
|-------------|--------|-------------|
| **Базовое пространство $X = \lVert N(\mathcal{C})\rVert$** | [Т] Формализовано | [Свойство 5](../foundations/axiom-omega#свойство-5) |
...
| **Компактификация 6D → 4D** | [П] Программа | Открытый вопрос |
| **Уравнения Эйнштейна** | [П] Программа | Требует связи с ОТО |
