...
- $\rho_*$ — единственное стационарное состояние $\mathcal{L}_\Omega$ [Т] (примитивность)
...
См. [Измерение Опыта](/docs/core/structure/dimension-e) и [Категория Exp](/docs/proofs/categorical/categorical-formalism#2-категория-exp).
