...
| Термин | Определение |
|--------|-------------|
| **IIT** | Integrated Information Theory — теория Тонони. УГМ обобщает: $C = \Phi \times D_{\text{diff}} \times R$ |
| **FEP** | Free Energy Principle — теория Фристона о минимизации свободной энергии |
| **GWT** | Global Workspace Theory — теория Баарса о глобальном доступе к информации |
| **Conscious Realism** | Теория Хоффмана; связь с УГМ: агент $\approx$ L2-Голоном (гипотеза) |
